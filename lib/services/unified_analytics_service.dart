...
class UnifiedAnalyticsService {
  ...
  void logOnboardingStart() {
    _scateService.trackOnboardingStart();
  }
  ...
  void logOnboardingFinish() {
    _scateService.trackOnboardingFinish();
  }

  /// Log paywall events
  void logPaywallShown(String name) {
    _scateService.trackPaywallShown(name);
  }

  void logPaywallClosed(String name) {
    _scateService.trackPaywallClosed(name);
  }
  ...
  void logPaywallPurchased(String name) {
    _scateService.trackPaywallPurchased(name);
  }
