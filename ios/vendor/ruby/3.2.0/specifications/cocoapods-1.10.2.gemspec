# -*- encoding: utf-8 -*-
# stub: cocoapods 1.10.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.10.2".freeze])
  ...
  s.add_runtime_dependency(%q<cocoapods-downloader>.freeze, [">= 1.4.0".freeze, "< 2.0".freeze])
  ...
  s.add_runtime_dependency(%q<cocoapods-trunk>.freeze, [">= 1.4.0".freeze, "< 2.0".freeze])
  s.add_runtime_dependency(%q<cocoapods-try>.freeze, [">= 1.1.0".freeze, "< 2.0".freeze])
  s.add_runtime_dependency(%q<molinillo>.freeze, ["~> 0.6.6".freeze])
  s.add_runtime_dependency(%q<xcodeproj>.freeze, [">= 1.19.0".freeze, "< 2.0".freeze])
  ...
  s.add_runtime_dependency(%q<ruby-macho>.freeze, ["~> 1.4".freeze])
